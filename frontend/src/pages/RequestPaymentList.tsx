...
const columns = [
  { title: '批量请款编号', dataIndex: 'batch_no', key: 'batch_no' },
  { title: '日期', dataIndex: 'request_date', key: 'request_date', render: dateFmt },
...
const formFields = (
  <>
    ...
    <Form.Item name="request_date" label="日期" rules={[{ required: true, message: '请选择日期' }]}>
    ...
    <Form.Item name="status" label="状态" initialValue="待请款">
      <Select placeholder="请选择状态">
        <Select.Option value="待请款">待请款</Select.Option>
        <Select.Option value="部分请款">部分请款</Select.Option>
        <Select.Option value="已请款">已请款</Select.Option>
      </Select>
    </Form.Item>
  </>
);
...
const expandedRowRender = (record: any) => {
  ...
  return (
    <div style={{ padding: '12px 12px 0 12px', background: '#fafafa' }}>
      <MiniCrudTable
        endpoint={`/request-payments/${parentId}/details`}
...
const RequestPaymentList: React.FC = () => {
  return (
    <CrudTable
      apiEndpoint="/request-payments/"
      columns={columns}
      title="请款管理"
